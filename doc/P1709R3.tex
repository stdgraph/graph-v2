...
\textbf{Date:} & \hl{September 13}, 2022 (mailing)\\ 
...
\hline
    ...
    \tcode{neighbor_view<VId, true, E, void>} & \tcode{source_id} & \tcode{target_id} & \tcode{neighbor} & \\
    ...
    \tcode{neighbor_view<VId, false, E, void>} & & \tcode{target_id} & \tcode{neighbor} & \\
