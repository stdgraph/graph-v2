...
struct _descriptor_traits {
  ...
  // container                  inner_id_type       inner_value_type
  // =========================  ================    ====================
  // vector<vector<int>>        difference_type     vector<int>
  // vector<map<int, double>>   difference_type     map<int, double>
  // vector<set<int>>           difference_type     set<int>
  // deque<deque<int>>          difference_type     deque<int>
  // deque<map<int, double>>    difference_type     map<int, double>
  // map<int, vector<int>>      int                 vector<int>
  //
